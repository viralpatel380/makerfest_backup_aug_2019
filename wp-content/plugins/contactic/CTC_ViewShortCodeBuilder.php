...
class CTC_ViewShortCodeBuilder extends CTC_View {
     ...
     <div class="wrap">
        <h1>
            ...
            <span style="margin-left:20px">
                <button id="reset_button" class="button"><?php echo esc_html(__('Reset', 'contact-form-7-to-database-extension')) ?></button>
            </span>
        </h1>
        <?php
    }
    ...
    public function outputTabLayout() {
        ...
        <div class="cfdb_params_div" style="margin-right:20px">
        ...
        <div>
            <div style="margin-bottom:10px">
                ...
                <a id="doc_url_tag" target="_docs"
                   href="https://contactic.io/docs/"><?php echo esc_html(__('Documentation', 'contact-form-7-to-database-extension')); ?></a>
                <br/>
            </div>
    ...
    public function displayExportControl() {
        ...
        <span id="userpass_span">
            ...
            <span id="label_gld_script" style="display:none">
                ...
                <a target="code"
                   href="<?php echo plugins_url('CTC_GoogleSSLiveData.php', __FILE__) ?>"><?php echo esc_html(__('Get code', 'contact-form-7-to-database-extension')); ?></a>.
